...
I created the [Autonomous Driving Data Framework (ADDF)](https://github.com/aws-samples/autonomous-driving-data-framework), an open-source platform used by OEMs including BMW Group and Qualcomm to process petabytes of autonomous driving data on AWS. My recent research, [NKI-Agent](https://arxiv.org/abs/2607.04395), combines domain-specific fine-tuning with a compile-verify-fix agent loop to generate hardware-optimized kernels for AWS Trainium.
